...
public class Question3 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		db = new UserDataSQLHelper(Question3.this).getWritableDatabase();
		...
		edittext.setOnKeyListener(new OnKeyListener() {
		    public boolean onKey(View v, int keyCode, KeyEvent event) {
		        ...
		        if ((event.getAction() == KeyEvent.ACTION_DOWN) &&
		          ...
		          Toast.makeText(Question3.this, "Thanks for your comment", Toast.LENGTH_SHORT).show();
		...
		startButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(Question3.this, OverviewMap.class).putExtra("startRecording", true);
	...
	public void onWindowFocusChanged(boolean hasFocus) {
		...
		if (hasFocus) {
			if (db==null || (!db.isOpen())) {
				db = (new UserDataSQLHelper(Question3.this)).getWritableDatabase();
				Log.d("Question3","just created new DB");
			}
